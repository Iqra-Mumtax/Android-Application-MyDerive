...
import static fastnu.cloudcomputingproject.R.color.commentTextColor;
...
public class Authentication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConstraintLayout = (ConstraintLayout) findViewById(R.id.constLayout);
        mConstraintLayout.setBackgroundColor(ContextCompat.getColor(this, commentTextColor));
